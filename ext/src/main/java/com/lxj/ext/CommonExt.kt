...
//一天只做一次
fun Context.doOnceInDay(actionName: String = "", keySuffix: String? = "", action: () -> Unit, whenHasDone: (()->Unit)? = null) {
...
//只执行一次的行为
fun Context.doOnlyOnce(actionName: String = "", keySuffix: String? = "", action: () -> Unit, whenHasDone: (()->Unit)? = null) {
