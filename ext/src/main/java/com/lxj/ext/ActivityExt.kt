...
import com.lxj.ext.util.LifecycleHandler
 ...
 * ```
 */
fun <T: ViewModel> FragmentActivity.getSavedStateVM( application: Application, clazz: Class<T>) = ViewModelProvider(this, SavedStateViewModelFactory(
    application, this)
).get(clazz)
...
fun Context.grantIntentUriPermission(intent: Intent, uri: Uri){
